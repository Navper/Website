...
const translations = {
    en: {
        ...
        'about.dateTransnaba': '03/2024 - Present',
        ...
        'about.pythonDev': 'Python & AI Developer',
        'about.pythonDesc1': "Developed a local Text-to-SQL AI agent using LangChain and Hugging Face, designed to automate report generation through a natural language chat interface.",
        'about.pythonDesc2': 'Engineered a complete data pipeline combining SQL extraction, Pandas for data processing, and LLM-driven executive summaries.',
        'about.pythonDesc3': 'Built a responsive Streamlit frontend with interactive Plotly visualizations and one-click PDF/Excel export, saving the administration team hours of manual work every week.',

        
        'skills.title': 'Skills',
        'skills.toolkit': '// my toolkit',
        ...
        'p4.title': 'AI Traffic Agent',
        'p4.desc': 'A complete data analysis platform featuring a Text-to-SQL AI agent. It allows traffic office staff to query a SQL database using natural language, processes the data with Pandas, generates AI executive summaries, and visualizes the results on a Streamlit dashboard with PDF/Excel exports.',
        'p4.f1': 'Text-to-SQL with LangChain & local Hugging Face model',
        'p4.f2': 'Automated data cleaning and processing using Pandas',
        'p4.f3': 'Data-to-Text executive summaries generated by LLM',
        'p4.f4': 'Streamlit interface with Plotly charts and data export',
        'p4.status': 'Professional',
    ...
    es: {
        ...
        'home.iambuilding': 'Construyo',
        'home.stat1.val': '2025',
        'home.stat1.label': 'Graduado',
        'home.stat2.val': '3+',
        'home.stat2.label': 'Proyectos',
        'home.stat3.val': '5+',
        'home.stat3.label': 'Tecnologías',
        ...
        'label.year': 'Año:',
        'about.dateIndalweb': '08/2025 - 02/2026',
        'about.dateTransnaba': '03/2024 - Presente',
        'about.dateAbogados': '03/2024 - 10/2024',
        'about.dateMedia': '01/2022 - 11/2022',
        ...
        'about.pythonDev': 'Desarrollador Python e IA',
        'about.pythonDesc1': 'Desarrollo de un agente de IA Text-to-SQL local usando LangChain y Hugging Face, diseñado para automatizar la generación de informes mediante chat.',
        'about.pythonDesc2': 'Creación de un pipeline de datos que combina extracción SQL, procesamiento con Pandas y resúmenes ejecutivos redactados por un modelo de lenguaje.',
        'about.pythonDesc3': 'Construcción de un frontend en Streamlit con gráficos interactivos y exportación a PDF/Excel, ahorrando horas de trabajo manual a la semana al equipo de administración.',

        
        'skills.title': 'Habilidades',
        'skills.toolkit': '// mi kit de herramientas',
        ...
        'p4.title': 'Agente de IA para Tráfico',
        'p4.desc': 'Plataforma de análisis de datos impulsada por un agente de IA Text-to-SQL. Permite al personal consultar la base de datos en lenguaje natural, procesa la información con Pandas, genera resúmenes ejecutivos por IA y visualiza los resultados en un dashboard de Streamlit exportable.',
        'p4.f1': 'Text-to-SQL con LangChain y modelo local de Hugging Face',
        'p4.f2': 'Limpieza y procesamiento automatizado de datos con Pandas',
        'p4.f3': 'Resúmenes ejecutivos (Data-to-Text) generados por LLM',
        'p4.f4': 'Interfaz en Streamlit con gráficos interactivos y exportación',
        'p4.status': 'Profesional',
